...
public class SellerListController implements Initializable, DataChangeListener{
	...
	private void initializeNodes() {
		...
		//allows the tableViewSeller to always have the same size of the Main Window
	...
	public void updateTableView() {
		...
		//adds an edit button in each cell allowing edition with the createDialogForm()
		initEditButtons();
		//adds a remove button in each cell allowing removal of a specific department
		initRemoveButtons();
	}
